...
SPREADS: dict[str, dict[str, Any]] = {
    ...
    "month": {"label": "이달의 타로", "count": 5},
    "year": {"label": "신년 타로", "count": 7},
...
SPREAD_POSITIONS: dict[str, list[dict[str, str]]] = {
    ...
    "worry": [
        {"label": "과거", "role": "지금까지의 흐름"},
        {"label": "현재", "role": "지금 마주한 핵심"},
        {"label": "미래", "role": "앞으로 펼쳐질 방향"},
    ],
    "month": [
        {"label": "1주", "role": "이번 달의 출발"},
        {"label": "2주", "role": "흐름이 잡히는 때"},
        {"label": "3주", "role": "한 달의 중심"},
        {"label": "4주", "role": "변화와 조율"},
        {"label": "마무리", "role": "한 달의 결"},
    ],
    "year": [
        {"label": "1-2월", "role": "한 해의 시작"},
        {"label": "3-4월", "role": "봄의 성장"},
        {"label": "5-6월", "role": "여름의 확장"},
        {"label": "7-8월", "role": "한가운데 전환"},
        {"label": "9-10월", "role": "가을의 수확"},
        {"label": "11-12월", "role": "겨울의 정리"},
        {"label": "총운", "role": "한 해를 관통하는 메시지"},
    ],
    "love": [
