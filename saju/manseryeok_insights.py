...
SINSAL_PLAIN: dict[str, str] = {
    "역마살": "이동·변화·해외·타지가 잦을 수 있습니다. 이사·출장·여행운이 붙기 쉬워요.",
    "도화살": "인기·매력·이성 인연이 강합니다. 감정 기복·관계 선택에 신중함이 필요해요.",
    "괴강살": "의지가 강하고 승부욕이 있습니다. 고집·충돌만 조절하면 추진력이 됩니다.",
    "공망": "헛수고·공허함을 느끼기 쉬운 시기가 있습니다. 기대를 낮추고 하나에 집중하면 좋아요.",
    "겁살": "갑작스런 손실·경쟁을 조심합니다. 투자·보증·공동투자는 신중히.",
    "원진살": "가까운 사람과 마찰이 생기기 쉽습니다. 말 한마디·오해를 줄이면 좋아요.",
    "고과살": "시비·구설·관재를 조심합니다. 계약·말실수에 유의하세요.",
    "태양도림": "큰 흉을 눌러주는 길한 기운으로 읽힙니다. 어려운 날에 도움이 될 수 있어요.",
    "삼재": "3년 주기로 변화·시련이 올 수 있다는 전통 설명입니다. 무리한 확장은 피하는 편이 좋아요.",
}
