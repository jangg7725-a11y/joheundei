...
SPREAD_OPENING: dict[str, str] = {
    ...
    "year": "올해는 열두 달, 열두 장의 장면입니다. 봄의 시작부터 겨울의 마무리까지, 계절처럼 이어지는 한 해의 서사를 따라가 보세요.",
...
ACT_PLAN: dict[str, list[dict[str, Any]]] = {
    ...
    "year": [
        {"title": "1분기 · 봄", "range": (0, 3)},
        {"title": "2분기 · 여름", "range": (3, 6)},
        {"title": "3분기 · 가을", "range": (6, 9)},
        {"title": "4분기 · 겨울", "range": (9, 12)},
    ],
    "love": [
...
def _compose_closing(
    ...
    advice: dict[str, str] = {
        ...
        "year": "12개월을 모두 통제하려 하지 마세요. 지금 달에 맞는 장면만 충실히 살아도, 연말의 결은 자연스럽게 따라옵니다.",
